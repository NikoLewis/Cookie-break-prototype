...
his project was forked from [Create React App](https://github.com/facebookincubator/create-react-app) and has been modified to use mostly ES5 (instead of ES6).
